...
Smooth.prototype = {
	...
	start: function() {
		this.reflow();
		if (this.setupListeners.update) this.raf = raf(this.handlers.run);
	},
	...
	addEvents: function() {
		...
		if (this.setupListeners.scroll) window.addEventListener('scroll', this.handlers.debounce);
	...
	removeEvents: function() {
		...
		if (this.setupListeners.update) raf.cancel(this.raf);
